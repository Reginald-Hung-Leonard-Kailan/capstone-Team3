    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        http
                ...
                .and()
                    ...
                    .requestMatchers("/", "/register", "/login", "/css/**", "/js/**", "/img/**", "/api/user") // anyone can see home, the ads pages, and sign up
                    .permitAll()
                .and()
                    .authorizeHttpRequests()
                    .requestMatchers(
                            "/home", // only authenticated users can create ads
                            "/client", "/posts/{id}/delete" // only authenticated users can edit ads
                    )
                    .authenticated()
        ;
        return http.build();
